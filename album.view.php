<?php
/**
 * album.view.php — Formulaire de téléchargement d'album avec token CSRF
 */
session_start();
...
<head>
    ...
    <link rel="icon" href="images/logo-jinnov.jpg">
</head>
<body>
    <header class="main-header">
        <div class="nav-container">
            <a href="index.html" class="logo"><img src="images/logo-jinnov.jpg" alt="Jinnov" class="logo-img"></a>
            <nav class="nav-menu">
    ...
    <main class="album-main">
        <section class="prose">
            ...
            <div id="success-message" class="form-message-success" role="status" aria-live="polite" style="display: none;">
                ...
                <!-- Promo impression photos -->
                <div class="promo-block">
                    <p class="promo-title">📸 <strong>Imprimez vos photos</strong></p>
                    <p class="promo-desc">Profitez de <strong class="promo-discount">-20%</strong> sur vos impressions avec le code :</p>
                    <div class="promo-code-display">
                        <code id="promoCodeDisplay">JINNOV20</code>
                        <button type="button" id="copyPromoBtn" class="copy-promo-btn">
                            <i class="fas fa-copy"></i> Copier
                        </button>
                    </div>
                    <a href="impression.html?promo=JINNOV20" class="btn btn-primary">
                        <i class="fas fa-print"></i> Commander mes impressions
                    </a>
                </div>
            </div>
